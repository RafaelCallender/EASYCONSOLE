...
namespace EASYCONSOLE.VIEW.TRANSLATE_VIEW.TRANSLATE_MAIN_VIEW
{
    internal class Translate_Main_View01
    {
        ...
        private string load_Translate_Main_View01_string()
        {


            return $"1.) Translate Text using API 01\n" +
                        $"2.) Translate Text using API 02\n" +
                        $"3.) Translate text using AI 01\n" +
                        $"4.) Translate textfiles\n" +
                        $"5.) Translate sqlexpress\n" +
                        $"6.) Translate sqlite\n" +
                        $"7.) Translate mysql\n" +
                        $"8.) go back\n";
        }
        ...
        private void load_Translate_Main_View01()
        {
            ...
            Console.WriteLine(load_Translate_Main_View01_string());
                    ...
                    if (Security_Serv01.string_only_digit(data01[1], out data01[24]) == true)
                    {
                        switch (int.Parse(data01[1]))
                        {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                new Translate_Selection_View04();
                                break;
                            case 5:
                                new Translate_Selection_View05();
                                break;
                            case 6:
                                new Translate_Selection_View06();
                                break;
                            case 7:
                                new Translate_Selection_View07();
                                break;
                            case 8:
                                Program.load_main();
                                break;
