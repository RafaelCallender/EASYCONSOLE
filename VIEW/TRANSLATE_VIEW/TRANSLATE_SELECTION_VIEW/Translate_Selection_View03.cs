...
namespace EASYCONSOLE.VIEW.TRANSLATE_VIEW.TRANSLATE_SELECTION_VIEW
{
  ...
  private static Language_Helper01  Language_H01= new Language_Helper01();   
        private static Language_Services03 Language_Serv03 = new Language_Services03(); 
        ...
        private string load_Translate_Selection_View03_string()
        {

            return $"1.) Translate Text using AI\n" +
                   $"2.) Back";
        ...
        private async Task load_Translate_Selection_View03()
        {
            ...
            Console.WriteLine(load_Translate_Selection_View03_string());
                            ...
                            case 1:
                                ...
                                if (Security_Serv01.empty_string(data01[4], out data01[23]) == true)
                                {
                                    ...
                                    if (Security_Serv01.empty_string(data01[6], out data01[24]) == true)
                                    {
                                        ...
                                        data01[7] = await Language_Serv03.Translate_using_Ai(Language_H01.code[int.Parse(data01[4])], data01[6]);
