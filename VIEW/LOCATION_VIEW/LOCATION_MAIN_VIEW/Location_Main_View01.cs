...
using EASYCONSOLE.VIEW.LOCATION_VIEW.LOCATION_SELECTION_VIEW;
namespace EASYCONSOLE.VIEW.LOCATION_VIEW.LOCATION_MAIN_VIEW
{
    internal class Location_Main_View01
    {
        ...
        private string load_Location_Main_View01_string()
        {
            return $"1.)location service 01\n" +
                        $"2.) go back";
        }
        ...
        private void load_Location_Main_View01()
        {
            ...
            Console.WriteLine(load_Location_Main_View01_string());
