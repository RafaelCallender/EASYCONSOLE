...
using EASY_CALLENDER01.SERVICES.MYSQL.MYSQL_SERVICES.MYSQL_MYEMAIL_SERVICES;
namespace EASYCONSOLE.VIEW.EMAIL_VIEW.EMAIL_SELECTION_VIEW
{
    internal class Email_Selection_View03
    {
        ...
        private string load_Email_View03_string()
        {
            return $"1.) insert_email\n" +
                ...
                $"11.) find_phonenumber_using_fullname\n";
        }

        private void load_Email_View03()
        {


            Console.WriteLine(load_Email_View03_string());
                        ...
                        switch (int.Parse(data01[1]))
                        {
                                                ...
                                                if (Security_S01.phone_check(data01[4], out data01[29]) == true)
                                                {
                                                    ...
                                                    if (Security_S01.empty_string(data01[5], out data01[30]) == true)
                                                    {
                                                        ...
                                                        if (Email_S01.send_email(data01[2], data01[3], data01[4], data01[5], out data01[31]) == true)
                                                        {
                                                            ...
                                                            if (MySql_Email_S01.insert_email(data01[2], data01[3], data01[4], data01[5], out data01[32]) == true)
                                                            {
                            ...
                            case 2:
                                ...
                                if (Security_S01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    ...
                                    {
                                        if (MySql_Email_S01.find_email_using_email(data01[3], out data01[25]) == true)
                                        {
                            ...
                            case 3:
                                ...
                                if (Security_S01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    if (MySql_Email_S01.find_email_using_name(data01[3], out data01[24]) == true)
                                    {
                            ...
                            case 4:
                                ...
                                if (Security_S01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    ...
                                    {
                                        if (MySql_Email_S01.find_email_using_phonenumber(data01[3], out data01[25]) == true)
                                        {
                                            Console.WriteLine(data01[25]);
                                            Console.WriteLine(load_Email_View03_string());
                                            data01[1] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 5:
                                ...
                                if (Security_S01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    if (Security_S01.email_check(data01[3], out data01[24]) == true)
                                    {
                                        if (MySql_Email_S01.find_full_name_using_email(data01[3], out data01[25]) == true)
                                        {
                                            Console.WriteLine(data01[25]);
                                            Console.WriteLine(load_Email_View03_string());
                                            data01[1] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 6:
                                ...
                                if (Security_S01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    if (MySql_Email_S01.find_full_name_using_full_name(data01[3], out data01[24]) == true)
                                    {
                                        Console.WriteLine(data01[24]);
                                        Console.WriteLine(load_Email_View03_string());
                                        data01[1] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 7:
                                ...
                                if (Security_S01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    if (Security_S01.phone_check(data01[3], out data01[24]) == true)
                                    {
                                        ...
                                        if (MySql_Email_S01.find_full_name_using_phonenumber(data01[3], out data01[25]) == true)
                                        {
                                            Console.WriteLine(data01[25]);
                                            Console.WriteLine(load_Email_View03_string());
                                            data01[1] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 8:
                                ...
                                if (Security_S01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    if (Security_S01.email_check(data01[3], out data01[24]) == true)
                                    {
                                        if (MySql_Email_S01.find_phonenumber_using_email(data01[3], out data01[25]) == true)
                                        {
                                            Console.WriteLine(data01[25]);
                                            Console.WriteLine(load_Email_View03_string());
                                            data01[1] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 9:
                                ...
                                if (Security_S01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    if (MySql_Email_S01.find_phonenumber_using_fullname(data01[3], out data01[24]) == true)
                                    {
                                        Console.WriteLine(data01[24]);
                                        Console.WriteLine(load_Email_View03_string());
                                        data01[1] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 10:
                                ...
                                if (Security_S01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    if (Security_S01.phone_check(data01[3], out data01[24]) == true)
                                    {
                                        if (MySql_Email_S01.find_phonenumber_using_phonenumber(data01[3], out data01[25]) == true)
                                        {
                                            Console.WriteLine(data01[25]);
                                            Console.WriteLine(load_Email_View03_string());
                                            data01[1] = Console.ReadLine() ?? string.Empty;
