...
namespace EASYCONSOLE.VIEW.CLIENT_VIEW.CLIENT_SELECTION_VIEW
{
    internal class Client_Selection_View01
    {
        ...
        private string load_Client_Selection_View01_String()
        {
            return $"1.) delete_client_using_email\n" +
                ...
                $"53.) view_client_database_stored_proceedure\n" +
                $"54.) go back\n";
        ...
        {
            Console.WriteLine(load_Client_Selection_View01_String());
                    ...
                    if (Security_Serv01.string_only_digit(data01[1], out data01[24]) == true)
                    {
                        switch (int.Parse(data01[1]))
                        {
                            ...
                            case 12:
                                ...
                                if (Security_Serv01.empty_string(data01[2], out data01[25]) == true)
                                {
                                    Console.WriteLine("Email Addresss\n");
                                    data01[3] = Console.ReadLine() ?? string.Empty;
                                    if (Security_Serv01.empty_string(data01[3], out data01[27]) == true)
                                    {
                                        if (Security_Serv01.email_check(data01[3], out data01[26]) == true)
                                        {
                                            Console.WriteLine("Phonenumber\n");
                                            data01[4] = Console.ReadLine() ?? string.Empty;
                                            if (Security_Serv01.empty_string(data01[4], out data01[28]) == true)
                                            {
                                                if (Security_Serv01.phone_check(data01[4], out data01[29]) == true)
                                                {
                                                    ...
                                                    if (Security_Serv01.empty_string(data01[5], out data01[30]) == true)
                                                    {


                                                        Console.WriteLine("cashapp\n");
                                                        data01[5] = Console.ReadLine() ?? string.Empty;
                                                        if (Security_Serv01.empty_string(data01[5], out data01[30]) == true)
                                                        {
                                                            Console.WriteLine("zelle\n");
                                                            data01[5] = Console.ReadLine() ?? string.Empty;
                                                            if (Security_Serv01.empty_string(data01[5], out data01[30]) == true)
                                                            {

                                                                Console.WriteLine("venmo\n");
                                                                data01[5] = Console.ReadLine() ?? string.Empty;
                                                                if (Security_Serv01.empty_string(data01[5], out data01[30]) == true)
                                                                {
                                                                    Console.WriteLine("venmo\n");
                                                                        ...
                                                                        if (Security_Serv01.empty_string(data01[5], out data01[30]) == true)
                                                                        {
                                                                            ...
                                                                            if (Security_Serv01.empty_string(data01[5], out data01[30]) == true)
                                                                            {
                                                                                ...
                                                                                if (Security_Serv01.empty_string(data01[5], out data01[30]) == true)
                                                                                {
                                                                                    ...
                                                                                    Console.WriteLine("company colors\n");
                                                                                    data01[5] = Console.ReadLine() ?? string.Empty;
                                                                                    if (Security_Serv01.empty_string(data01[5], out data01[30]) == true)
                                                                                    {
                            ...
                            case 53:
                                int count = 0;
                                if (Sql_Client_S01.view_client_database_storedprocedures(out data01[24]) == true)
                                {
                                    foreach (var a in data01[24].Split('\n'))
                                    {
                                        count++;
