...
{
    internal class Journal_Selection_View02
    {
        ...
        {
            load_Journal_Selection_View02().Wait();
        }
        private string load_Journal_Selection_View02_string()
        {
            return $"1.) Write Journal using sqlite\n" +
                   $"2.) go back";
        }
        private async Task load_Journal_Selection_View02()
        {

            Console.WriteLine(load_Journal_Selection_View02_string());
