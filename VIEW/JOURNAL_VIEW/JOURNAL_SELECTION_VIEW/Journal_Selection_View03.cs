...
{
    internal class Journal_Selection_View03
    {
        ...
        {
            load_Journal_Selection_View03().Wait();
        }
        private string load_Journal_Selection_View03_string()
        {
            return $"1.) Write Journal using Mysql\n" +
                   $"2.) go back";
        }
        private async Task load_Journal_Selection_View03()
        {

            Console.WriteLine(load_Journal_Selection_View03_string());
