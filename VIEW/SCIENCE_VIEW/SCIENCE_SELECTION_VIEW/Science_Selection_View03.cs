...
{
    internal class Science_Selection_View03
    {
        ...
        public Science_Selection_View03()
        {
            ...
            load_Science_Selection_View03().Wait();
      
        }
        private async Task<string> load_Science_Selection_View03_String()
        {


            return

                     $"{await Chemistry_Serv03.insert_element_using_sqlite()}\n" +
                     $"{await Chemistry_Serv03.insert_category_elements_using_sqlite()}\n" +
                     $"1.)find_element_using_sqlite\n" +
                     $"2.)view_all_elements_using_sqlite\n" +
                     $"3.)find_category_elements_using_sqlite\n" +
                     $"4.) go back\n";


        }
        private async Task load_Science_Selection_View03()
        {




            Console.WriteLine(await load_Science_Selection_View03_String());
                        ...
                        switch (int.Parse(data01[1]))
                        {
                            case 1:
                                ...
                                if (Security_Serv01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    ...
                                    data01[4] = await Chemistry_Serv03.find_element_using_sqlite(data01[3]);
                            ...
                            case 2:
                                ...
                                data01[4] = await Chemistry_Serv03.view_all_elements_using_sqlite(); ;
                                Console.WriteLine(data01[4]);
                                Console.WriteLine(await load_Science_Selection_View03_String());
                                data01[1] = Console.ReadLine() ?? string.Empty;
                                break;
                            case 3:
                                ...
                                if (Security_Serv01.empty_string(data01[3], out data01[23]) == true)
                                {
                                    ...
                                    {
                                        data01[4] = await Chemistry_Serv03.find_category_elements_using_sqlite(int.Parse(data01[3]));
                                        Console.WriteLine(data01[4]);

                                        Console.WriteLine(load_Science_Selection_View03_String());
                                        data01[1] = Console.ReadLine() ?? string.Empty;
                                        break;
                                    }
                                    else
