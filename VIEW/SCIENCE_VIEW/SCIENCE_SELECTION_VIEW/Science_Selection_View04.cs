...
{
    internal class Science_Selection_View04
    {
        private static string[] data01 = new string[100];
        private static Security_Services01 Security_Serv01 = new Security_Services01();
            private static Chemistry_Services04 Chemistry_Serv04=new Chemistry_Services04();  
                    private static MySql_Chemistry_Services02 MySql_Chemistry_Serv02 = new MySql_Chemistry_Services02();
                        private static Chemistry_Helper01 Chemistry_H01=new Chemistry_Helper01();  
    private static int count = 0;    

        public Science_Selection_View04()
        {
            load_Science_Selection_View04().Wait();
        }
        private string load_Science_Selection_View04_String()
        {

if(Chemistry_Serv04.insert_element_using_mysql()==true)
            {
                if(Chemistry_Serv04.insert_category_elements_using_mysql()==true)
                {
            return   $"1.)find_element_using_Mysql\n" +
                     $"2.)view_all_elements_using_Mysql\n" +
                     $"3.)find_category_elements_using_Mysql\n" +
                     $"4.) go back\n";               
                }
                else
                {
        ...
        private async Task load_Science_Selection_View04()
        {




            Console.WriteLine(load_Science_Selection_View04_String());
