...
private static int count = 0;       
        ...
        private string load_Science_Selection_View01_String()
        {
            return   $"1.)find_element_using_textfile\n" +
                     $"2.)view_all_elements_using_textfile\n" +
                     $"3.)find_category_elements_using_textfile\n" +
                     $"4.) go back\n";
        ...
        private async Task load_Science_Selection_View01()
        {
            ...
            Console.WriteLine(load_Science_Selection_View01_String());
            ...
            break;
                            ...
                            case 2:
                                ...
                                data01[4] = Chemistry_Serv01.view_all_elements_using_textfile();
            ...
            break;
              ...
              case 3:
                                ...
                                if (Security_Serv01.empty_string(data01[3],out data01[23]) == true)
                                {
                                    ...
                                    {
                                        data01[4] =  Chemistry_Serv01.find_category_elements_using_textfile(int.Parse(data01[3]));
                                        Console.WriteLine(data01[4]);
